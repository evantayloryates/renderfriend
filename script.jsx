...
(function() {
  ...
  //     // // Begin undo group
  //     // app.beginUndoGroup("Add and Animate Square");
  ...
  //     // // Create solid
  //     // var squareSolid = activeItem.layers.addSolid([0, 0, 0], "root__square", 50, 50, 1);
      
  //     // // Center the solid in the comp
  //     // squareSolid.position.setValue([compWidth / 2, compHeight / 2]);

  //     // // Set opacity keyframes
  //     // var opacity = squareSolid.property("ADBE Transform Group").property("ADBE Opacity");
  //     // opacity.setValueAtTime(5, 0);
  //     // opacity.setValueAtTime(6, 100);
  ...
  //     activeItem.comment = activeItem.comment + " there";
        
  //   }
  //   // Define the string you want to save
  //   var data = "This is the data I want to save.";
    

  //   // %%% INSERTIONPOINT %%% //
  //   // Create a new file object
  //   var file = new File("/Users/taylor/src/github/aenode/data.txt");

  //   // Open the file for writing
  //   if (file.open("w")) {
  //     // If successfully opened, write the data
  //     file.write(data);
  //     // Close the file
  //     file.close();
  //   }
  ...
  // Check if render queue is not empty
  if (rq.numItems > 0) {
      for (var i = rq.numItems; i >= 1; i--) {
          var rqi = rq.item(i);
          if (rqi.comp.name == "norender") {
              rqi.remove();
          }
      }
  }
